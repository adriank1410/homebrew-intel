...
# The runner image's core checkout contains both tracked and untracked provisioning changes.
# Do not clean/delete it. Move the entire preseeded checkout into RUNNER_TEMP and clone a fresh,
# independently verified official core checkout at Homebrew's expected tap path.
...
[[ "$(/usr/bin/git -C "$core_dir" remote get-url origin)" == https://github.com/Homebrew/homebrew-core.git ]] || exit 1
